...
DrawFormattedText(windowPtr, 'Each picture contains one kind of figure, and at least two colors out of blue, yellow, red, green, and white.\n\n\n',width/10,height*(1/2),white,lb);
...
% Put the message in white
DrawFormattedText(windowPtr, 'To make sure that you are comfortable with the task, there are 6 practice trials. After each practice trial the correct answer is shown. After trials of the experiment you will not be given that information. \n\n\nAfter the practice trials you may take a break to ask the proctor questions. If you have any questions before the practice trials begin, please ask them now.\n\n\n',width/10,'center',white,lb);
