...
% Put the message in white
DrawFormattedText(windowPtr, 'In some cases, you will be asked a follow-up question. \nThe question will either ask you about certain information contained in the picture you just saw, or it will ask you to solve a simple math equation. \n\nUse the keyboard to input your answer, and then press RETURN to continue. \n\nIf you do not know the answer, simply provide your best guess and continue on to the next trial. \n\n\n',width/10,'center',white,lb);
